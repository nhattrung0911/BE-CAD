...
CATALOG = {
    ...
    "hex-nut-iso4033": Product(
        product_id="hex-nut-iso4033",
        standard="ISO4033",
        family="hex_nut",
        name="High hex nut ISO 4033",
        parameters=[
            ParameterSpec(name="d", label="Nominal diameter"),
            ParameterSpec(name="s", label="Across flats"),
...
VARIANTS = {
    ...
    "hex-nut-iso4033": [
        {
            "variant_id": "hex-nut-iso4033-m5",
            "sku": "HEX-NUT-ISO4033-M5",
            "label": "M5 high nut",
            "diameter_label": "M5",
            "params": {"d": 5, "s": 8.0, "m": 5.6},
            "material": "carbon_steel",
        },
        {
            "variant_id": "hex-nut-iso4033-m8",
            "sku": "HEX-NUT-ISO4033-M8",
            "label": "M8 high nut",
            "diameter_label": "M8",
            "params": {"d": 8, "s": 13.0, "m": 8.0},
            "material": "carbon_steel",
        },
        {
            "variant_id": "hex-nut-iso4033-m10",
            "sku": "HEX-NUT-ISO4033-M10",
            "label": "M10 high nut",
            "diameter_label": "M10",
            "params": {"d": 10, "s": 17.0, "m": 10.0},
            "material": "carbon_steel",
        },
    ],
    "button-head-iso7380": [
        ...
        },
        {
            ...
            "label": "M5 x 10 mm",
            "diameter_label": "M5",
            "params": {"d": 5, "L": 10, "P": 0.8, "dk": 9.5, "k": 2.75, "s": 3.0, "t": 1.7},
            "material": "alloy_steel",
        },
        {
